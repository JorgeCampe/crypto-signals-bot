...
MIN_EDGE = _f("CRYPTO_MIN_EDGE", 0.015)          # ventaja minima modelo vs Kalshi para operar
...
MIN_VOLUME = _f("CRYPTO_MIN_VOLUME", 200)      # contratos 24h minimos (mercados finos = precios falsos)
